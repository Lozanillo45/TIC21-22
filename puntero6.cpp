...
int main(){
        ...
        char provisional[10];
        char *aux;//reservo una variable auxiliar para guarda de momento la direccion de la palabra
    ...
    //Las ordeno por orden alfabéticoO
	...
	//VUELVO A MOSTRAR PALABRAS PERO ORDENADAS
